...
El codigo interpreta una base de dator introducida como csv (no header) como un objeto que posee en sus atributos las herramientas necesarias para estandarizarlo en una matriz binaria.
