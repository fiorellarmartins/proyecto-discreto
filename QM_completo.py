...
mt = cum.brasilcum
#[int(i) for i in input("Ingrese los Minterminos: ").strip().split()]
...
print("\n\n\n\nGrupo No.\tMinterminos\tMinterminos binario\n%s" % ('='*50))
